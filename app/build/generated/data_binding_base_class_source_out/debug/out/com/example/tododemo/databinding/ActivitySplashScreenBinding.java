...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView tvSplashScreen;

  private ActivitySplashScreenBinding(@NonNull RelativeLayout rootView,
      @NonNull ImageView tvSplashScreen) {
    this.rootView = rootView;
    this.tvSplashScreen = tvSplashScreen;
  }
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.tvSplashScreen;
      ImageView tvSplashScreen = ViewBindings.findChildViewById(rootView, id);
      if (tvSplashScreen == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((RelativeLayout) rootView, tvSplashScreen);
    }
